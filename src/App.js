  ...
  return (
      <div className="App">
          <div>
              ...
              <div>
                  <Card pic={first} text ="BlahBlah!: yep bla bla blaa Bllaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa" topic="Heading One" />
          ...
          <div>
              ...
              <div>
                  ...
                  <Card pic={seven} text ="More Blahh an lalalala" topic="Heading Six" />
              </div>
          </div>
      </div>
  );
